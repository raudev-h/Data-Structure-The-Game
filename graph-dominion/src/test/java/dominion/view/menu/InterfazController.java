...
public class InterfazController implements Initializable {
    ...
    private void playButtonAction() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/mapa/mapa.fxml"));
    ...
    private void informationButtonAction(){
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/informacion/Information.fxml"));
